...
export class ProductRead2Component implements AfterViewInit {
  ...
  displayedColumns = ['id', 'nome', 'numero_registro','email','telefone_residencial', 'telefone_comercial', 'telefone_celular', 'ramal', 'cep','uf', 'estado', 'cidade', 'endereco_residencial', 'bloco', 'complemento'];
